...
<div class="MainAppContainerPage">
	...
	<section>
		...
		<div class="SystemDescriptor" data-is-edit={ false } >
			<div>Author</div> 
			<div >{activePreview?.author ?? unknownString}</div>
		
			<div>Version</div> 
			<div >{activePreview?.version ?? unknownString}</div>
		
			<div>SystemCodeName</div> 
			<div >{activePreview?.systemCodeName ?? unknownString}</div>
		
			<div>editable</div> 
			<div >{activePreview?.isEditable ?? unknownString}</div>
		
			<div>SystemName</div> 
			<div >{activePreview?.systemName ?? unknownString}</div>
		 
			<div>folder name</div> 
			<div >{activePreview?.folderName ?? unknownString}</div>
